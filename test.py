...
mapping = {'repeat': {'S': {'REPEAT': '1'},
           ...
           'операнд': {'S': {'константа_любая': 'F', 'идентификатор': '1'},
                       ...
                       '2': {'разделитель': 'r2', 'константа': '3', 'идентификатор': '3'},
                       'r2': {'константа': '3', 'идентификатор': '3'},
                       '3': {'разделитель': 'r3', ']': 'F'}, 'r3': {']': 'F'}},
           'константа_любая': {'S': {'1|..|9': '1', '-': '3', '0': '6'},
                               '3': {'1|..|9': '1', '0': '4'},
                               '1': {'цифра': '1', '⊥': 'F', '.': '2'},
                               '2': {'цифра': '5'},
                               '5': {'цифра': '5', '⊥': 'F'},
           ...
           'буква': {'S': {'a|..|z': 'F', 'A|..|Z': 'F'}},
           'цифра': {'S': {'0|..|9': 'F'}},
           'REPEAT': {'S': {'R': '1'}, '1': {'E': '2'}, '2': {'P': '3'}, '3': {'E': '4'}, '4': {'A': '5'}, '5': {'T': 'F'}},
           'UNTIL': {'S': {'U': '1'}, '1': {'N': '2'}, '2': {'T': '3'}, '3': {'I': '4'}, '4': {'L': 'F'}},
           'DIV': {'S': {'D': '1'}, '1': {'I': '2'}, '2': {'V': 'F'}},
           'MOD': {'S': {'M': '1'}, '1': {'O': '2'}, '2': {'D': 'F'}},
           'AND': {'S': {'A': '1'}, '1': {'N': '2'}, '2': {'D': 'F'}},
           'OR': {'S': {'O': '1'}, '1': {'R': 'F'}},
           'XOR': {'S': {'X': '1'}, '1': {'O': '2'}, '2': {'R': 'F'}}}
# from loader import load_mapping
# from pathlib import Path
# mapping = load_mapping(Path('test0.dot').read_text())
# print(mapping)
